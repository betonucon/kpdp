      ...
      <div class="modal-body">
          ...
          <form method="get" id="my_simpan">
            ...
            <div class="form-group">
              ...
              <label>Jabatan </label>
              <input type="text" name="jabatan" class="form-control"  placeholder="Isi disini">
            
            
              <label>Tentang</label>
              
              <textarea class="textarea" name="moto" placeholder="Ketikan isi disini......" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">
              ...
              <input type="number" name="urut" class="form-control" style="width:20%" placeholder="Isi disini">
            </div>
          </form>
      </div>
