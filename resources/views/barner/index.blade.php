      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Daftar Tampilan Barner</h3>
          </div>
            <!-- /.box-header -->
          <div class="box-body">
