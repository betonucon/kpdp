...
class PengumumanController extends Controller
{
    public function index(request $request){
        ...
        return view('pengumuman.index',compact('menu'));
    }
        ...
        echo'
            ...
            <div class="form-group">
                ...
                if($data['gambar']==''){
                    ...
                    echo'<img src="'.url(link_html().'file/barner/'.$data['gambar']).'" class="gambar-news">
    ...
    public function view_data(request $request){
        ...
        echo'
            <table width="100%" class="table table-bordered" >
                ...
                if($cek>0){
                    $data=Pengumuman::where('name','LIKE','%'.$request->name.'%')->orderBy('id','Desc')->get();
                }else{
    ...
    public function simpan(request $request){
        ...
        if (isset($error)) {echo '<p style="padding:5px;background:#d1ffae"><b>Error</b>: <br />'.implode('<br />', $error).'</p>';} 
            ...
            $lokasi=link_directory().'file/barner/';
